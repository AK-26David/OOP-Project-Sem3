...
///////////////////////////////////////////////receipt/////////////////////////////////////
	...
	//-------------------------------------------------setting PANEL and LABELS for Welcome section
	    ...
	    ImageIcon titleImage = new ImageIcon("../images/Brown Munde.gif");
	...
	//--------------------------------------COMBO BOX for current date
		...
		Integer[] currentYearCB = {2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029, 2030};
	...
	//---------------------------------------------Pick up date section
		...
		Integer[] pickUpYearCB = {2024, 2025, 2026, 2027, 2028, 2029, 2030};
	...
	//-------------------------------------------return date section
		...
		Integer[] returnYearCB = {2024, 2025, 2026, 2027, 2028, 2029, 2030};
	...
	//-----------------------------------------------to go customer section
		ImageIcon dateNextImage = new ImageIcon("../images/next.jpg");
	...
	//-------------------------------------TEXT FIELD for customer details and get data from keyboard section
		firstNameTF = new JTextField(""); // set as 10 ha 
		...
		lastNameTF = new JTextField(""); // kani pud
	...
	//----------------------------------------------to go pick a car section
		ImageIcon customerNextImage = new ImageIcon("../images/next.jpg");
	...
	//--------------------------------------------to go back reserve section
		...
		ImageIcon customerBackImage = new ImageIcon("../images/back.jpg");
	...
	//---------------------------------------------------------Pick Car Buttton]
	//-------------------------------------first car button
		ImageIcon firstCarImage = new ImageIcon("../images/r.gif");
	...
	//---------------------------------second car button
		ImageIcon secondCarImage = new ImageIcon("../images/sedan.gif");
	...
	//---------------------------------------third car button
		ImageIcon thirdCarImage = new ImageIcon("../images/suv.gif");
	...
	//------------------------------------------forth car button
		ImageIcon forthCarImage = new ImageIcon("../images/supercar.GIF");
	...
	//--------------------------------------------------------------------to go back customer section
		ImageIcon carBackImage = new ImageIcon("../images/back.jpg");
	...
	//-----------------------------------TEXT AREA for pick a car putting details for car when we click buttons over top
		...
		carDetailsTA.setText("Choose one of the following:");
	...
	private class firstCarButton implements ActionListener{ //when its clicked show up the car detail of Van
		...
		carDetailsTA.setText("Brand: Volkswagen\nPlate #: lxa755\nType: HatchBack\nModel: Polo\nColor: Yello\nRental Price: P1500.00\n\n-Used for tourists, family \nuse, business!!!\nWonderful car for \nbachelor trips!!\n Budget friendly!!!!!");
	...
	private class secondCarButton implements ActionListener{ //button to show pick-up details
		...
		carDetailsTA.setText("");
		carDetailsTA.setText("Brand: Audi\nPlate #: aqt555\nType: Sedan\nModel: A3\nColor: Red\nRental Price: P2500.00\n\n-Oftenly used for families.\nUsed for Long Distance \nTravels or city travel!!");
	...
	private class forthCarButton implements ActionListener{ //button to show Bus details
		...
		carDetailsTA.setText("");
		carDetailsTA.setText("Brand: Lamborghini \nPlate #: bsd444\nType: SuperCar\nModel: Aventador\nColor: Orange\nRental Price: P20000.00\n\n-chick magnet,\ncan be used for cruising too.\n Perfect for a car enthusiast!");
	...
	private class finalStepButton implements ActionListener{
		public void actionPerformed(ActionEvent event) {
			...
			if(event.getActionCommand().equals("Car1")) { //passing the pick-up details to car details class and final transactions.
				...
				String carType = "HatchBack", carModel = "Polo";
				double carPrice = 1500.00;
				...
				String carType = "Sedan", carModel = "S3";
				double carPrice = 2500.00;
				...
				String carType = "SUV", carModel = "AMG G63";
				...
				String carType = "SuperCar", carModel = "Aventador";
